export const frFR = {
  ...
  studio: {
    ...
    export: {
      ...
      exportAll: "Exporter tous les artefacts",
  ...
  setupWizard: {
    ...
    fixes: {
      worker: "Démarrez le worker : uv run --env-file .env surreal-commands-worker --import-modules commands",
    },
  },
}
...
const rootNode = frFR as unknown as LocaleTree;
...
Object.assign(ensureSection(rootNode, 'mindMap'), {
  ...
  filterArtifacts: "Artefacts ({count})",
