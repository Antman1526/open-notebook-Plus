export const ruRU = {
  ...
  studio: {
    ...
    export: {
      ...
      savedExports: "Сохранённые экспорты",
      availableCount: "Доступно: {count}",
      groupEditable: "Редактируемые",
      groupVisual: "Визуальные",
      groupData: "Данные",
      groupSource: "Источник",
      groupBundle: "Пакет",
      download: "Скачать {label}",
      open: "Открыть",
      openTooltip: "Открыть {label}",
      copy: "Копировать",
      copyPath: "Копировать путь {label}",
      copied: "Скопировано",
...
const rootNode = ruRU as unknown as LocaleTree;
